...
const TreeMenuItem = forwardRef( ( {
  ...
  const actions = [
    ...
    },
    {
      ...
      icon: <ChevronDown />,
      label: formatMessage( {
        id: getTrad( 'ui.move.categoryItem.down' ),
    ...
    },
    {
      ...
      icon: <ChevronUp />,
      label: formatMessage( {
        id: getTrad( 'ui.move.categoryItem.up' ),
    ...
    },
    {
      ...
      icon: <Trash />,
      label: formatMessage( {
        id: getTrad( 'ui.delete.categoryItem' ),
        defaultMessage: 'Delete Category item',
      } ),
      onClick: onDelete,
    },
  ];
